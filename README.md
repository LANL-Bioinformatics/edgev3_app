...
- Required runtime and reference data are summarized in [`docs/Required_DATA.md`](docs/Required_DATA.md). Reference databases are downloaded from <https://ref-db.edgebioinformatics.org/edgev3/> into `data/refdata`.
